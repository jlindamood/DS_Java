...
public class Process {
  ...
  private int firstProcessTick; // Local variable to hold the time when this process was first ticked. Added by James Lindamood.
  ...
  public void setFirstProcessTick(int time) {this.firstProcessTick = time;}; // Method to set the time when the process was first ticked. Added by James L.

  public int getFirstProcessTick() {return this.firstProcessTick;} // method to return the time when the process was first ticked. Added by James L.
}
